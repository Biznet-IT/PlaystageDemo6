...
#include "SKGMLECharacterMovement.generated.h"

class FSavedMove_MapEditor;
class FNetworkPredictionData_Client;

UCLASS()
class SKGMULTIPLAYERLEVELEDITOR_API USKGMLECharacterMovement : public UCharacterMovementComponent
{
	GENERATED_BODY()
public:
	USKGMLECharacterMovement(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
